...
export function PasswordEdit() {
    ...
    const schema = Yup.object().shape({
        ...
        password: Yup.string().required("Digite a senha atual").min(6, "Minimo 6 caracteres"),
        new_password: Yup.string().required("Digite uma nova senha").min(6, "Minimo 6 caracteres"),
        confirm_new_password: Yup.string().required("Confirme sua senha").oneOf([Yup.ref('new_password'), null], 'As senhas devem coincidir'),
    ...
    const onSubmit = async clientData => {
        ...
        try {
            ...
            toast.error(
            error.response?.data?.error || "Erro ao trocar senha"
            )
        }
        }
        ...
        <Container>
            ...
            <ContainerItems>
                ...
                <H1 style={{marginLeft: "-20px"}}>Trocar senha</H1>
                    ...
                    <Button type="submit">Atualizar senha</Button> {/* Alterado de "Fazer login" para "Registrar" */}
                </form>
