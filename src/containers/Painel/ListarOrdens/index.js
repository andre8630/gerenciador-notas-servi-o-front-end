...
import { Container, ContentContainer, Input, Header, SearchButton, ClearButton } from "./styles"
            ...
            <ContentContainer>
                <form onSubmit={handleSubmit(onSubmit)}>
                    <Header key={ordens.id}>
                        ...
                        <ClearButton type="button" onClick={handleReset}>Limpar</ClearButton>
                    </Header>
                </form>
                    ...
                    <Table sx={{ minWidth: 300 }} aria-label="simple table">
                        ...
                        {ordens && ordens.map((row) => (
                           ...
                           <TableRow 
                            ...
                            <TableCell className='tableValue' component="th" scope="row">{row.id}</TableCell>
                            <TableCell className='tableValue'>{row.name}</TableCell>
                            <TableCell className='tableValue'>{formatedData(row.createdAt)}</TableCell>
