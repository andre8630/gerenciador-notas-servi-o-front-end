...
export function ImageContent({ images, newImages = [], onRemoveImage }) {
    ...
    const allImages = [...(images || []), ...newImages.map(file => ({
    ...
    const navigateImages = (direction) => {
        ...
        const imageUrl = typeof image === 'string'
            ? `http://192.168.200.103:${port}/files/${image}`
            : image.url || image;
            ...
            {selectedImage && (
                <ModalOverlay onClick={closeModal}>
                    <ModalContent onClick={(e) => e.stopPropagation()}>
                        ...
                        <NavigationArrow direction="left" onClick={(e) => {
                            e.stopPropagation();
                            navigateImages('prev');
                        }}>
                            &#10094;
                        ...
                        <NavigationArrow direction="right" onClick={(e) => {
                            e.stopPropagation();
                            navigateImages('next');
                        }}>
                            &#10095;
